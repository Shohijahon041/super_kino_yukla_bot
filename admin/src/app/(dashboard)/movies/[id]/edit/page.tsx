...
export default function EditMoviePage() {
  ...
  React.useEffect(() => {
    async function fetchData() {
      try {
        const [movieRes, genresRes, countriesRes, languagesRes] = await Promise.all([
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await movies.updateMovie(movieId, {
        title: form.title,
      ...
      addToast({ title: "Movie updated", description: "The movie has been updated successfully.", variant: "success" });
      router.push("/movies");
    } catch {
      addToast({ title: "Error", description: "Failed to update movie.", variant: "destructive" });
    } finally {
      setSaving(false);
    }
  };
